...
Ext.application({
    ...
    launch: function() {
        ...
        var ListHelper = Ext.create('My.ListHelper'),
            list = ListHelper.getList(),
            formHelper = Ext.create('My.FormHelper'),
            form = formHelper.getForm(),
            downloadHelper = Ext.create('My.DownloadHelper'),
            downloadPanel = downloadHelper.getDownloadPanel(),
            removeHelper = Ext.create('My.RemoveHelper'),
            removePanel = removeHelper.getRemovePanel(),
            printHelper = Ext.create('My.PrintHelper'),
            printPanel = printHelper.getPrintPanel();

	Ext.Viewport.fullscreen = true;        
